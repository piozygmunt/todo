...
export class ArchivedTodosComponent {
  ...
  private archivedToDosQueryChange: Subject<ArchivedTodosQuery> = new Subject<ArchivedTodosQuery>();
  private archivedToDosQueryChange$: Observable<ArchivedTodosQuery> = this.archivedToDosQueryChange.asObservable();
